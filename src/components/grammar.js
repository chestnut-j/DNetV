        ...
        return (
            <div className='grammar-box' >
                <div className='sub-title'>&nbsp;Grammar
                  <Upload className="upload-item" {...props}
　　　　　　　　　　　　　　fileList={fileList}
                    >
                    ...
                    <svg className="icon" aria-hidden="true"  onClick={this.Export}>
                        <use xlinkHref="#icon-download"></use>
                    </svg>
                </div>
                <div className='filename'>{this.state.filename}</div>
                <div className='json-text'>
                  <ReactJson className="json-box"  { ...this.state.jsonOptions } src={ this.state.jsonData } />
                </div>
            </div>
        );
    }
