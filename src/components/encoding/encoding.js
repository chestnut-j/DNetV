                ...
                <div className='encoding-table-container' >
                    ...
                    <div className='encoding-item'>
                        <div className="encoding-item-title" >
                            <Button
                                type={this.props.options.encodingType.indexOf('visible') > -1 ? 'primary' : 'default'}
                            ...
                            <div className='visible-picker-box'>
                                <Button id='visible-button'
                                    ...
                                    style={{
                                        ...
                                        borderColor: (options.visible.isVisible) ? '#6495ED' : '#B0C4DE',
                    ...
                    <div className='encoding-item'>
                        <div className="encoding-item-title" >
                            <Button
                                type={ this.props.options.encodingType.indexOf('position') > -1 ? 'primary' : 'default'}
                        ...
                        <div className="encoding-item-content" >
                            ...
                            <div className='item-right-container'>
                                <div className="item-right-option">
                                    ...
                                    <Input value={options.position.totalWidth} type='number' onChange={(e)=>this.handleTimeOptionsInput(e, 'position', 'totalWidth')} style={{ width: '65px' }} />
                                </div>
                                <div className="item-right-option">
                                    <text>EachWidth:</text>
                                    <Input value={options.position.eachWidth} type='number' onChange={(e)=>this.handleTimeOptionsInput(e, 'position', 'eachWidth')} style={{ width: '65px' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='encoding-item'>
                        ...
                        <div className="encoding-item-content" >
                            ...
                            <div className='item-right-container'>
                                <div className="item-right-option">
                                    <text>Speed:</text>
                                    <Input value={options.animation.speed} type='number' onChange={(e)=>this.handleTimeOptionsInput(e, 'animation', 'speed')} style={{ width: '65px' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='encoding-item'>
                        <div className="encoding-item-title" >
                            <Button
                                type={this.props.options.encodingType.indexOf('color') > -1 ? 'primary' : 'default'}
                        ...
                        <div className="encoding-item-content" >
                            ...
                            <div className='item-right-container'>
                                <div className="item-right-option">
                                    <text>Number:</text>
                                    <Input value={options.color.number} type='number' onChange={(e)=>this.handleTimeOptionsInput(e, 'color', 'number')} style={{ width: '65px' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='encoding-item'>
                        <div className="encoding-item-title" >
                            <Button
                                type={this.props.options.encodingType.indexOf('link') > -1 ? 'primary' : 'default'}
