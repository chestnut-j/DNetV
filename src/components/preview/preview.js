...
export default function Preview(props) {
    ...
    const [renderType, setRenderType] = useState(`${props.relationOptions.taskType}-${props.encodingOptions.encodingType[0]}`)
    ...
    useEffect(()=>{
        if(props.jsonfile.graphs){
            setRenderType(`${props.relationOptions.taskType}-${props.encodingOptions.encodingType[0]}`)
        }else{
            setRenderType('')
        }
    }, [props.relationOptions.taskType, props.encodingOptions.encodingType[0], props.jsonfile.graphs])
